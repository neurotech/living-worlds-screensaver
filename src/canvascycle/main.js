...
var CanvasCycle = {
  ...
  init: function() {
    if (!this.inited) {
      ...
      var initialScene = require(path.join(
        __dirname + "/scenes/jungle-waterfall/rain"
      ));
      this.initScene(initialScene);
      this.run();
      // this.setSound(prefs.sound);
    }
  },
  ...
  startSceneAudio: function() {
    ...
    var scene = require(path.join(__dirname + "/scenes/jungle-waterfall/rain"));
