...
var FrameCount = {
  ...
  update: function () {
    ...
    if (div) {
      ...
      html += "<table>";
      html +=
        '<tr><td align="right"><b>Current FPS:</b></td><td align="left">' +
        this.current +
        "</td></tr>";
      html +=
        '<tr><td align="right"><b>Average FPS:</b></td><td align="left">' +
        this.average +
        "</td></tr>";
      html +=
        '<tr><td align="right"><b>Total Frames:</b></td><td align="left">' +
        this.totalFrames +
        "</td></tr>";
      html += "</table>";
  ...
  count: function () {
    ...
    if (_int_now != this.lastSecond) {
      ...
      if (_int_now > this.startTime)
        this.average = this.totalFrames / (_int_now - this.startTime);
